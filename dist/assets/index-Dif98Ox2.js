...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:ps,depthTest:!1,depthWrite:!1})}function xd(){return new nr({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:lh(),fragmentShader:`
		...
		`,blending:ps,depthTest:!1,depthWrite:!1})}function yd(){return new nr({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:lh(),fragmentShader:`
		...
		`,blending:ps,depthTest:!1,depthWrite:!1})}function lh(){return`
